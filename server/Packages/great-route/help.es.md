...
- **Kilómetros** (25, 50, 75, 100, 200): avanzan tu coche. Solo puedes jugarlas *en marcha* y sin pasarte de la meta (la llegada es exacta). Solo dos cartas de 200 por mano.
- **Ataques**: se lanzan a un rival *en marcha* — Semáforo rojo, Sin gasolina, Pinchazo y Accidente lo detienen; el Límite de velocidad le impide jugar más de 50 hasta que lo quite.
- **Remedios**: curan tu problema — Semáforo verde (arranca o quita el rojo), Gasolina, Rueda de recambio, Reparación y Fin del límite. Ojo: reparar **no arranca** — tras la Gasolina, la Rueda o la Reparación sigues parado hasta jugar un Semáforo verde (salvo que tengas la Prioridad de paso). El Fin del límite sí te libera directamente.
- **Inmunidades** (una de cada): te protegen para siempre de un problema y quitan el que tengas puesto. La *Prioridad de paso* te protege del semáforo **y** del límite.

## El golpe bajo

Si te atacan y tienes en la mano la inmunidad que cubre ese ataque, puedes responder al instante: el ataque se anula, sumas una bonificación grande **y el turno pasa a ser tuyo**.

## Puntuación de la mano

1 punto por kilómetro; 100 por inmunidad jugada (300 extra por las cuatro); 300 por golpe bajo; 400 por completar el viaje; 300 por viaje seguro (sin cartas de 200); 300 por completar con el mazo agotado; 500 por dejar a un rival a cero.

Empieza la mano **parado**: necesitas un Semáforo verde (o la Prioridad de paso) para arrancar.
