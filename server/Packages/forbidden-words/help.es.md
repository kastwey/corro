...
Describe un objetivo a tu compañero sin decir el objetivo ni ninguna palabra de su carta privada. El otro equipo aporta un supervisor. Corro nunca escucha, graba ni transcribe la conversación: las personas deciden cuándo una respuesta es correcta y cuándo se ha usado una palabra prohibida.

## Equipos y funciones

El anfitrión crea dos equipos iguales. Los turnos se alternan entre ellos.
...
El anfitrión elige un idioma común para las palabras al crear la partida y puede cambiarlo en la sala de espera. Todos juegan con el mismo mazo de objetivos y palabras prohibidas, mientras los botones y la ayuda conservan el idioma de la interfaz de cada jugador.
...
El portavoz describe el objetivo en voz alta. El adivinante responde en voz alta. Corro no incluye un cuadro para escribir respuestas porque la conversación y el juicio humano son el juego.
...
- **Ctrl+Shift+F1** lee las reglas efectivas del temporizador, la puntuación y los pases.
