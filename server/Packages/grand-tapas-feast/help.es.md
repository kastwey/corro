...
Estás de tapeo con la cuadrilla y todo el mundo pide **a la vez**: cada jugador elige en
...
1. Elige una carta de tu mano con **Intro** — tu elección es secreta y puedes **cambiarla**
   mientras quede alguien por pedir.
2. Cuando toda la mesa ha pedido, las cartas se destapan a la vez sobre la mesa de cada uno.
3. Tu bandeja (lo que no elegiste) pasa al jugador de tu izquierda, y recibes la del de tu
   derecha. Cuando las bandejas se acaban, la ronda se puntúa.

## Las tapas

- **Pinchos** (banderilla 1, tortilla 2, gamba 3): valen sus puntos tal cual.
- **Salsa brava**: espera en tu mesa y **triplica** el próximo pincho que te sirvas.
  Sola no vale nada.
- **Croquetas**: cada **pareja** vale 5 puntos (una suelta, nada).
- **Montaditos**: cada **trío** vale 10 puntos (sueltos, nada).
- **Cuenco de aceitunas**: cuantos más cuencos, mejor — 1/3/6/10/15 puntos por 1/2/3/4/5+.
- **Bandejas de tapas** (1, 2 o 3 raciones): al final de la ronda, quien más raciones
  reúna suma 6; el segundo, 3. Empate arriba: se reparte el 6 y nadie lleva el 3.
- **Flan casero**: se guarda hasta el **final de la partida** — quien más flanes tenga
  suma 6, quien menos pierde 6 (a dos jugadores nadie pierde puntos).
- **Pinzas de servir**: esperan en tu mesa. Gástalas para coger **dos tapas en un mismo
  turno** (activa la selección múltiple con **Ctrl+Espacio**, marca dos cartas con
  Espacio y envíalas con Intro; la primera marcada se sirve primero — una salsa marcada
  antes que un pincho lo multiplica en esa misma jugada). Las pinzas vuelven entonces a
  la bandeja que pasas: se las quedará tu vecino. Solas no valen puntos.

## Detalles finos

- Nadie ve tu bandeja ni tu petición: solo se anuncia **quién** ha pedido ya.
- La salsa brava solo atrapa pinchos servidos en **turnos posteriores**.
- Desempate final: gana quien tenga más flanes.
