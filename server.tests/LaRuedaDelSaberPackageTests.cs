...
/// <summary>
/// Pins the shipped "La Rueda del Saber" trivia package: the wheel shape, the CC0 question
...
/// </summary>
public class LaRuedaDelSaberPackageTests
{
	private static readonly Task<GameDefinition> Loaded =
		new CorroPackageLoader().LoadAsync(CorroTestPaths.PackageDir("la-rueda-del-saber"));
