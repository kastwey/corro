...
Roll along a 20-space path. Landing on a boost moves you forward; a setback moves you back. Reach the final space first.

## Help during play

- **F1** opens this guide.
- **Ctrl+F1** opens all shortcuts.
- **Ctrl+Shift+F1** reads the effective finish and extra-roll rules.

## Your turn

Press **Space** to roll. The piece walks automatically, including any landing effect.
