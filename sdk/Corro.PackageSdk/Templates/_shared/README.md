...
3. Optional card art belongs in `assets/cards/<card-id>.svg` (64×64, path geometry only). A card may add `artColor: "#RRGGBB"`; missing art uses Corro's neutral fallback. Never put package-specific drawings in engine code.
