...
For a shorter introduction to tools, JSON and all ten families, read the
[beginner package guide](package-authoring.md) ([Spanish](package-authoring.es.md)) first.
